  ...
  return (
    <div className="bg-white rounded-md p-4">
      ...
      <div className="flex mt-4">
        ...
        />
        <button className='bg-secondary border border-secondary text-white text-sm font-bold ml-2 px-2 rounded-md hover:bg-white hover:text-secondary' stlye={{ marginTop: "10px" }} onClick={handleAddEvent}>
          Add Event
        </button>
      </div>
      <Calendar
