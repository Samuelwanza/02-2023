...
const ClientIndividualProfessionalPage = ({ id }) => {
  ...
  const professional = {
    name: profile.attributes.name,
    jobtitle: profile.attributes.Field_of_specialisation,
    bio: profile.attributes.bio,
    completedProjects: 128,
    activeProjects: 30,
    rating: 4.0,
    skills: profile.attributes.skills.split(","),
    experience: [
      {
    ...
    <>
      <div>
        ...
        <div className="bg-white p-6 rounded-md">
          {/* left */}
          <div className="">
            <p className=" flex justify-center text-grey-900 text-center text-xl font-extrabold">
              Profile
            </p>
